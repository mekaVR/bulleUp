...
class ComicBookAuthor(models.Model):
    ...
    oeuvre = models.ForeignKey(ComicBook, on_delete=models.CASCADE)
...
class Review(models.Model):
    ...
    work = models.ForeignKey(ComicBook, on_delete=models.CASCADE)
    publication_date = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"Review by {self.user} on {self.work}"
